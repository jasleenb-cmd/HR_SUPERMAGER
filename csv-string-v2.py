...
df = pd.DataFrame(employee_info, columns = ["EID", "FirstName", "LastName", "username", "password"])
#print(df)
df.to_csv("employee_info.csv", sep=",", encoding="utf-8")
...
#print(payroll)
df = pd.DataFrame(payroll, columns = ["EID", "contract_type", "hour_count", "unit_pay", "total_pay"])
#print(df)
df.to_csv("payroll.csv", sep=",", encoding="utf-8")
...
df = pd.DataFrame(schedule, columns = ["EID", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"])
#print(df)
df.to_csv("schedule.csv", sep=",", encoding="utf-8")            
...
df = pd.DataFrame(training, columns = ["EID", "training_name", "completion_date"])
#print(df)
df.to_csv("training.csv", sep=",", encoding="utf-8")   
